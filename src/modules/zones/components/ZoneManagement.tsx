      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-[#101D1A] border border-[rgba(196,154,84,0.20)] p-4 rounded-lg flex items-center gap-4 shadow-md transition-all duration-300 hover:border-[#C49A54]/50">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-[#F2E9DB]">{pagedZones?.totalCount ?? 0}</p>
                  ...
                  >
                    ...
                    <TableCell className="text-right pr-6">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="bg-[#101D1A] border border-[rgba(196,154,84,0.2)] w-40 text-[#F2E9DB]">
