      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-[#112128] border border-[rgba(196,154,84,0.20)] p-4 rounded-lg flex items-center gap-4 shadow-md transition-all duration-300 hover:border-[#C49A54]/50">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-[#FFFFFF]">{pagedTurns?.totalCount ?? 0}</p>
        ...
        <div className="bg-[#112128] border border-[rgba(196,154,84,0.20)] p-4 rounded-lg flex items-center gap-4 shadow-md transition-all duration-300 hover:border-[#C49A54]/50">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-[#FFFFFF]">{activeTurnsCount}</p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
            ...
            <Select value={sortBy} onValueChange={setSortBy}>
              ...
              <SelectContent className="bg-[#112128] border-[rgba(196,154,84,0.20)] text-[#FFFFFF]">
                ...
                <SelectItem value="start-asc" className="text-xs focus:bg-[#0B1519] focus:text-[#C49A54] cursor-pointer">Hora Inicio Asc.</SelectItem>
                <SelectItem value="start-desc" className="text-xs focus:bg-[#0B1519] focus:text-[#C49A54] cursor-pointer">Hora Inicio Desc.</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
              ...
              <TableBody>
                {sortedData.map((turn) => (
                  ...
                  >
                    ...
                    <TableCell className="text-xs font-mono text-[#FFFFFF]">
                    ...
                    <TableCell className="text-right pr-6">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="bg-[#112128] border border-[rgba(196,154,84,0.2)] w-48 text-[#FFFFFF]">
